...
<div id="bodysecon" class="row">
    <h3><center><div class="card-panel hoverable">Dashboard Devel</div></center></h3>
</div>

<!--ingresamos el link del power bi para mostrar luego-->
<?php
$dashboardUrl = "https://app.powerbi.com/view?r=eyJrIjoiMjkyYjM1MDktNjgyMS00Mzc3LWJmZTEtOTIxM2RjMGEwMWVmIiwidCI6Ijc0MzBjOGJlLWQ1ZTMtNDgxYi1hNTcwLTZjOGI0MzRkZGY4OCIsImMiOjZ9"; // Reemplaza esto con tu URL de Power BI
?>
