...
?>
    ...
    <div class="col s12 m6 offset-m3">
      <div class="card">
        <div class="card-content">
          <span class="card-title center-align">Hemos envia un codigo de verificacion a su correo</span>
          <form id="form-verificar-codigo" method="POST">
            <div class="input-field">
              <input id="codigo" name="codigo" type="text" class="validate" required>
              <label style="font-size: 10px;" for="codigo">Coloque el codigo de verificacion</label>
            </div>
            <div class="center">
              <button id="botonVerificar" class="btn waves-effect waves-light" type="submit" name="action">Validar
  ...
  <div class="row center">
    <div class="col s12" style="position: fixed; bottom: 0;">
      <span class="black-text" style="font-size: 14px;">&copy; Devel cibersecurity</span>
    </div>
  </div>
  <!-- Derechos reservados -->
